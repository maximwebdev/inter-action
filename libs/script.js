(function (e) {
  ...
  (n.mobileMenu = {
    ...
    menuMobile: function () {
      if (e(".main-navigation .menu > ul").length) {
        ...
        if (pointbreak >= window_width) {
          ...
          e(".aft-dynamic-navigation-elements").addClass(
          ...
          e(".aft-dynamic-navigation-elements").removeClass(
            "aft-mobile-navigation"
          );
        }
      }
    ...
    menuArrow: function () {
      if (e("#masthead .main-navigation div.menu > ul").length) {
        e("#masthead .main-navigation div.menu > ul .sub-menu")
          .parent("li")
          .find("> a")
          .append('<button class="mobile-has-submenu">');
    ...
    (n.SwiperSlider = function () {
      ...
      $(".swiper-container-videos .swiper-wrapper .swiper-slide a").on(
        "click",
        function () {
          $(this)
